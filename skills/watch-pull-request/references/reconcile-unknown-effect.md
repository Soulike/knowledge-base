...
push, reply, resolution, metadata update, or CI replay before attempting it
again. Retrieve only the resource state needed to establish that result; the
normal next observation cycle reconciles the complete PR.
