...
| [`verify-skills.yml`](../../workflows/verify-skills.yml)                                     | Skills, references, instructions, prompts | Quarterly, day 15 at 04:11 UTC |
...
`AGENTS.md` is an Agent-instruction unit. Markdown files under one
`.github/scripts/*/prompts/` directory form one prompt unit so the verifier sees
their complete input and guidance relationship.
