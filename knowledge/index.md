...
| [knowledge/github-actions/agent-run-state-and-reruns.md](github-actions/agent-run-state-and-reruns.md)     | evergreen      | Read when a multi-stage GitHub Actions workflow runs an Agent and carries its selected subject, result artifact, or publication state into a later job or rerun.                      |
