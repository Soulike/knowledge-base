...
Keep the primary workflow and completion criteria in the main file. Load branch-specific references only from the decisions that require them, and keep one authoritative copy of each rule.
