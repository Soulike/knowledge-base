---
name: PROTOTYPE gh-aw verify maintained Agent content
...
concurrency:
  group: prototype-gh-aw-content-verification-agent-content
...
Review every maintained Skill bundle, shared reference, Agent instruction, and
repository-owned prompt target at the checked-out revision. Use the installed
review Skills only as references. Search both open and closed issue history
before deciding that an affected target needs a new issue.
