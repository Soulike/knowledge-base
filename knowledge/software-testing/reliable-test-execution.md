...
This document defines framework-independent execution principles that make automated test results complete, reproducible, and fail-safe across test design, harnesses, runners, and CI.
