...
| ---------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [knowledge/agents/generalizing-source-material.md](agents/generalizing-source-material.md)                 | Read when extracting reusable Knowledge from a concrete case, choosing an evidence-supported claim scope, or deciding whether general and product- or platform-specific material should share or split documents. |
